...
class ImageOnScroll extends Component< ImageOnScrollProps, ImageOnScrollState > {
    ...
    viewportScroll() {
        ...
        if(this.scrollY<this.headerHeight){
        ...
        }else if(this.scrollY<this.headerHeight+this.stretchWidth){
            console.log("phase2");
            currentWidth = this.closedWidth + (this.scrollY-this.headerHeight);
            ...
            this.accordion.style.height = this.closedHeight + "px";
        }else if(this.scrollY<(this.headerHeight+this.stretchWidth+this.openHeight-this.closedHeight)){
            console.log("phase3");
            ...
            this.accordion.style.left = (this.sizeX - currentWidth)/2 + "px";
            this.accordion.style.width = currentWidth + "px";
            this.accordion.style.height = (this.closedHeight + (this.scrollY-(this.headerHeight+this.stretchWidth))) + "px";
        }else{
            console.log("phase4");
            currentWidth = this.openWidth;
            this.accordion.style.position = "absolute";
